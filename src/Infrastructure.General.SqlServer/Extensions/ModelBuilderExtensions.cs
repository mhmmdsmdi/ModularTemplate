...
namespace Infrastructure.General.SqlServer.Extensions
{
    public static class ModelBuilderExtensions
    {
        ...
        /// <summary>
        ///     Set DateTime sql column types to 'datetime2(0)'
        /// </summary>
        /// <param name="modelBuilder"></param>
        public static void ApplyDateTimeColumnTypeToAllEntities(this ModelBuilder modelBuilder)
        {
            foreach (var entityType in modelBuilder.Model.GetEntityTypes())
            {
                foreach (var mutableProperty in entityType.GetProperties())
                    if (mutableProperty.ClrType == typeof(DateTime) || mutableProperty.ClrType == typeof(DateTime?))
                        mutableProperty.SetColumnType("datetime2(0)");
            }
        }

        ///// <summary>
        /////     Apply global filter for deletedat column
        ///// </summary>
        ///// <param name="modelBuilder"></param>
        //public static void ApplyGlobalFilterForDeletedAt(this ModelBuilder modelBuilder, string columnName)
        //{
        //    foreach (var entityType in modelBuilder.Model.GetEntityTypes())
        //    //if (entityType.ClrType == typeof(FullBaseEntity))
        //    {
        //        var deletedAtProperty = entityType.FindProperty(columnName);
        //        if (deletedAtProperty == null) continue;
